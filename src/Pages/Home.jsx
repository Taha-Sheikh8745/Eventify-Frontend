        ...
        <div className="container">
          ...
          >
            {events.slice(0, 3).map((event, index) => (
              ...
              >
                <div className="card-img-wrap" onClick={() => openLightbox(event.images?.[0] || '/hero-banner.jpg')}>
                  <motion.img
                    src={event.images?.[0] || '/hero-banner.jpg'}
                    alt={event.title}
                    onError={(e) => { e.target.onerror = null; e.target.src = '/hero-banner.jpg'; }}
    ...
    <div className="wedding-home">
      ...
      <section className="hero-wedding">
        <div className="hero-background">
          <motion.img
            src="/hero-banner.jpg"
            alt="Luxurious Event Planning Ballroom"
